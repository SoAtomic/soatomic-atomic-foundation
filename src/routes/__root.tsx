...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SoAtomic is a boutique digital workshop that helps small organizations build digital foundations they actually own. Screen. Build. Care. Grow." },
      { name: "author", content: "SoAtomic" },
      { property: "og:title", content: "SoAtomic — A Boutique Digital Workshop" },
      { property: "og:description", content: "A small workshop building dependable digital foundations for organizations doing meaningful work. Clients own everything." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "SoAtomic — A Boutique Digital Workshop" },
      { name: "twitter:description", content: "A small workshop building dependable digital foundations for organizations doing meaningful work. Clients own everything." },
