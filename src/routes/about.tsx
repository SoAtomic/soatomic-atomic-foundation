...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SoAtomic is a boutique digital workshop in Santa Cruz County, California. Documentation, ownership, and long-term relationships over client volume." },
      { property: "og:title", content: "About — SoAtomic" },
      { property: "og:description", content: "A small workshop, intentionally kept small. Aaron and a handful of clients each year." },
    ],
  }),
  component: AboutPage,
});
  ...
  return (
    <>
      <PageHead
        ...
        sub="SoAtomic is a small digital workshop in Santa Cruz County, California. It exists to help organizations doing meaningful work build digital foundations they understand and control."
      />

      <section className="py-20">
        <div className="mx-auto max-w-4xl px-6 space-y-8 text-lg text-muted-foreground">
          <p>
            The workshop was created because most small organizations are
          ...
          <p>
            ...
            workshop builds ships with a written record of how it works, who
            owns it, and how to keep it running.
          </p>
          <p>
            Long-term relationships are more valuable than maximizing client
            volume. The workshop's default posture is to be useful for years,
            not months.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 border-t border-border/60">
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <h2 className="mt-6 text-3xl md:text-4xl font-semibold">The workshop owner.</h2>
          <div className="mx-auto mt-6 max-w-3xl space-y-4 text-lg text-muted-foreground text-left md:text-center">
            ...
            <p>
              ...
              instead of being intimidated by it. The workshop model is a
      ...
      <section className="py-20 border-t border-border/60">
        <div className="mx-auto max-w-7xl px-6">
          <H2 eyebrow="Scope" sub="A short list of what the workshop does and does not offer. Being specific about both is part of respecting a client's time.">
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-5">
            <div className="atomic-card p-7">
              <div className="flex items-center gap-2 font-mono-soa uppercase tracking-widest text-primary">
                <Check className="h-3.5 w-3.5" /> The workshop provides
              </div>
            ...
            <div className="atomic-card p-7">
              <div className="flex items-center gap-2 font-mono-soa uppercase tracking-widest text-accent-orange">
                <X className="h-3.5 w-3.5" /> The workshop does not provide
              </div>
              <ul className="mt-5 space-y-3">
                {NO.map((t) => (
      ...
      <CtaBanner
        ...
        body="A short conversation is the fastest way to know. If we are not the right workshop for the work, we will say so directly."
